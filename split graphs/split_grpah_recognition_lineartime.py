...
This program determines if an input graph is a split graph or not.
...
def is_split(graph):
    ...
    It then identifies the cutoff index, which is the largest index i such that degree[i] >= i.
