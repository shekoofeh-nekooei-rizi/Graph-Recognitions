...
using **partition refinement** technique, which I learned in "A Simple Linear Time Algorithm for Cographs Recognition" by Bretscher, Corneil, Habib, and Paul.
...
and this program correctly  recongnizes it as not chordal in under two minutes (around a minute in my experiments).
